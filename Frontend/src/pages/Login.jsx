    ...
    <div className="min-h-screen flex items-center justify-center bg-background px-4">
      <div className="max-w-md w-full space-y-8 bg-surface p-8 rounded-xl border border-zinc-800 shadow-2xl">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-zinc-400">Sign in to your ResFlow account</p>
        </div>
          ...
          <div className="space-y-4 text-sm font-mono">
            ...
            <div>
              <div className="flex justify-between mb-2">
                ...
                <Link to="#" className="text-accent hover:text-accentSecondary transition">Forgot password?</Link>
              </div>
              <input
                type="password"
                {...register('password')}
        ...
        <p className="text-center text-sm text-zinc-400">
          Not a member? <Link to="/register" className="text-accent hover:underline">Create an account</Link>
        </p>
      </div>
    </div>
  );
