  ...
  return (
    <div className="min-h-screen flex bg-dark">
      ...
      <div className="hidden lg:flex w-1/2 relative flex-col items-center justify-center p-12 overflow-hidden bg-dark-100">
        ...
        >
          <div className="w-24 h-24 rounded-3xl bg-gradient-to-br from-violet-500 to-cyan-500 shadow-glow-violet flex items-center justify-center mb-8">
          ...
          <p className="text-xl text-gray-400 max-w-md leading-relaxed">
            Join ResFlow today and let AI help you land your dream job faster.
          </p>
        </motion.div>
      </div>
        ...
        >
          ...
          <div className="glass-panel p-8">
            <div className="mb-6">
              ...
              <p className="text-gray-400">Unlock your career potential</p>
            </div>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              ...
              <div>
                ...
                {errors.confirmPassword && <p className="mt-1.5 text-sm text-rose-400">{errors.confirmPassword.message}</p>}
              </div>
